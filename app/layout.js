...
// Fonts configure karne ke liye hum standard Google web fonts use kar rahe hain jo hamari globals.css me mapped hain.
...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      <head>
        {/* Importing required brand fonts via Google Fonts */}
      ...
      <body>
        ...
        {/* ── Floating WhatsApp Button (Global Communication) ── */}
        <a 
